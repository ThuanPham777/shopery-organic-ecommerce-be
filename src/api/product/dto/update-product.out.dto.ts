...
export class UpdateProductOutDto {
...
export class UpdateProductOutRes extends ApiRes<UpdateProductOutDto> {
    @ApiProperty({ type: UpdateProductOutDto })
    declare data: UpdateProductOutDto;
}